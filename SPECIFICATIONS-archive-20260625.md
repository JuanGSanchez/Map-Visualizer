> **ARCHIVED (2026-06-28).** This is the original, fully-delivered product specification list (SPEC-01..SPEC-23, all implemented and tested on the `enhancement/map-visualizer-20260625` branch). It is retained for history only and is superseded by `SPECIFICATIONS.md` (post-review remediation specs). Do not implement from this file.
